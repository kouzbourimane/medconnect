...
class PatientLoginForm extends StatefulWidget {
  const PatientLoginForm({Key? key}) : super(key: key);

  @override
  _PatientLoginFormState createState() => _PatientLoginFormState();
}
...
class _PatientLoginFormState extends State<PatientLoginForm> {
  ...
  Widget build(BuildContext context) {
    // Access ViewModel
    final viewModel = Provider.of<PatientAuthViewModel>(context);
