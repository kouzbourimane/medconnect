...
from .models import User, PatientProfile, DoctorProfile, Appointment, Notification, MedicalDocument, MedicalRecord
...
class MedicalRecordSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = MedicalRecord
        fields = [
            'id', 'patient', 'doctor', 'doctor_name', 'title', 
            'description', 'diagnosis', 'treatment', 'record_date', 
            'created_at'
        ]
